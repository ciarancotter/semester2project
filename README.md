...
## Intro
Boole Raider is a truly unique gaming experience that combines cutting-edge technology with the classic gameplay of a 2D roguelike platformer. Rather than relying on traditional controller inputs, the game utilizes machine vision to allow players to control their character in a whole new way. By using a Kinect, players can physically move and gesture to navigate their way through the game's challenging levels.

But the innovation doesn't stop there. Boole Raider also employs the use of advanced AI technology to generate its in-game text and art. The game's dialogue and descriptions are generated by GPT-3, a powerful natural language processing model, while the artwork is created by DALL.E, an AI model capable of generating stunning visuals from text descriptions.

With its groundbreaking use of technology and engaging gameplay, Boole Raider is sure to offer players a truly unforgettable gaming experience unlike anything they've ever encountered before.

### Inspiration
We were inspired by the games made for the Xbox Kinect as well as the sudden advances of AI models such as ChatGPT and DALL.E. We dived into this project aiming to bring these emerging technologies together, and striving to learn how to apply these technologies in to a time sensitive application such as a game.
...
During the course of this project, we learned several valuable lessons that helped us to improve our skills and work better as a team. One of the most important lessons we learned was how to use Github effectively. We used pull requests extensively, with over 130 pull requests merged to the main branch. We used Github's branch protection system to protect the main branch from unwanted commits. We found this to work very well. We learned how to collaborate with each other on Github by working on different branches and merging changes into the main branch.

Another valuable skill we learned was programming with the Pygame library. Pygame is a powerful tool for creating games and interactive applications using Python. We learned how to use Pygame to create animations and interactive art. The artists of our group improved their skills with pixil art and learned to work with other useful drawing tools.
