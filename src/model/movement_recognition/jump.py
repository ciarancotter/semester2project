...
class Jump(object):
    ...
    Methods:
      __call__(kinect: PyKinectV2, body: PyKinectRuntime.KinectBody) -> None:
        updates the read according to whether or not the body is jumping or not.
      get_speed_threshhold() -> int:
        get the speed threashold needed to be reached to allow a jump to be recognised
    ...
    def get_speed_threshhold(self) -> int:
        ...
        Returns:
          int:
            the speed threashold needed to be reached to allow a jump to be recognised.
        """
